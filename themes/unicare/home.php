            ...
            <div class="main-slider">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="main-content">
                                <h1 class="title">Natural <span>&</span> Safe Products</h1>
                        ...
                        <div class="col-md-7">
                            <div class="main-image">
                                <img src="<?php bloginfo('template_url'); ?>/assets/img/woman1.png" alt="Woman">
                            </div>
                            <!-- /.main-image -->
                        </div>
                        <!-- /.col-md-7 -->
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="main-image">
                                <img src="<?php bloginfo('template_url'); ?>/assets/img/woman2.png" alt="Woman">
                            </div>
                            <!-- /.main-image -->
                        </div>
                        <!-- /.col-md-7 -->
                        ...
                        <div class="research-content__list">
                            <ul>
                                <li>
                                    ...
                                    <a class="read-more" href="#"><img src="<?php bloginfo('template_url'); ?>/assets/img/carrot-right.svg"
                                            alt="Carrot right"></a>
                                </li>
                                <li>
                                <li>
